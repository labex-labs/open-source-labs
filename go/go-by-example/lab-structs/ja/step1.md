...
- `main` 関数は、以下の内容を出力する必要があります。
  - 名前が "Bob" で年齢が 20 歳の新しい構造体。
  - 名前が "Alice" で年齢が 30 歳の新しい構造体。
  - 名前が "Fred" で年齢が 0 歳の新しい構造体。
  - 名前が "Ann" で年齢が 40 歳の新しい構造体へのポインタ。
  - `newPerson` 関数を使用して構築された名前が "Jon" で年齢が 42 歳の新しい構造体。
  - 名前が "Sean" で年齢が 50 歳の構造体の `name` フィールド。
  - 名前が "Sean" で年齢が 50 歳の構造体への構造体ポインタの `age` フィールド。
  - `age` フィールドが 51 に更新された後の、名前が "Sean" で年齢が 50 歳の構造体への構造体ポインタの `age` フィールド。
