# _Generics_ (Genéricos)

O problema a ser resolvido neste laboratório é entender como definir e usar funções e tipos genéricos em Golang.

- Entender o conceito de _generics_ em Golang.
- Saber como definir funções genéricas com parâmetros de tipo e restrições.
- Saber como definir tipos genéricos com parâmetros de tipo.
- Entender como definir métodos em tipos genéricos.
- Saber como invocar funções genéricas com inferência de tipo.
