...
3. Delete the example.txt file using the command `rm file2.txt`.
4. Run the command `git log --oneline` to view the commit history.
5. Identifies a commit where a file was deleted with the message "Added file2.txt".
