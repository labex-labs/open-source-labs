...
Für diese Herausforderung verwenden wir das Git-Repository mit der URL `https://github.com/git/git`. Dieses Repository enthält Submodule, die nicht automatisch kloniert werden, wenn Sie das Repository klonen.
...
3. Wechseln Sie zum richtigen Commit der Submodule, d.h. zur `master`-Branche.
