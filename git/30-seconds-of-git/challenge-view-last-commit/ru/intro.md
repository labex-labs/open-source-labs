...
Git - это популярная система контроля версий, которая позволяет разработчикам отслеживать изменения в их кодовой базе. Одной из важных функций Git является возможность просматривать последнее коммит, сделанный в репозитории. В этом испытании вы научитесь просматривать последний коммит, сделанный в репозитории Git.
