...
2. Trouvez tous les commits qui ont modifié la chaîne de caractères "Git Playground" dans le fichier `README.md` et utilisez les flèches pour naviguer dans la liste des commits. Appuyez sur <kbd>Q</kbd> pour quitter le journal.
