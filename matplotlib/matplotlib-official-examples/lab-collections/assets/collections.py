...
col = collections.LineCollection([spiral], offsets=xyo, offset_transform=ax1.transData)
...
col = collections.PolyCollection([spiral], offsets=xyo, offset_transform=ax2.transData)
