...
最后，我们将使用`text()`和`Circle()`方法为图形添加注释，以展示各种Matplotlib元素的名称。我们还将使用`withStroke()`方法为文本和标记添加白色轮廓，以提高可见性。
...
def annotate(x, y, text, code):
    ...
    # 将path_effects用作文本的背景
    # 分别绘制path_effects和彩色文本，以便path_effects不会裁剪其他文本
...
annotate(1.68, -0.39, "x轴标签", "ax.set_xlabel")
annotate(-0.38, 1.67, "y轴标签", "ax.set_ylabel")
...
annotate(0.65, 0.01, "x轴", "ax.xaxis")
annotate(0, 0.36, "y轴", "ax.yaxis")
