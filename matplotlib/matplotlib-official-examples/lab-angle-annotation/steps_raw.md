# Matplotlib Tutorial: Creating a Scale Invariant Angle Label
...
### Step 2: Define `AngleAnnotation` Class
...
### Step 3: Define Helper Function `plot_angle`
...
### Step 4: Plot Two Crossing Lines and Label Each Angle Between Them with the Above `AngleAnnotation` Tool.
...
### Step 5: Showcase Different Text Positions and Size Units
