...
Любой `~.path.Path` может быть использован в качестве маркера. Следующий пример показывает два простых пути _звезда_ и _круг_, а также более сложный путь круга с вырезанной звездой.
