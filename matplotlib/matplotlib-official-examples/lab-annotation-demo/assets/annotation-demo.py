...
ax.annotate("figure points", xy=(107, 110), xycoords="figure points", fontsize=12)
ax.annotate(
    "figure fraction",
    xy=(0.025, 0.975),
...
ax.annotate(
    ...
    textcoords="offset points",
    arrowprops=dict(
        arrowstyle="->", connectionstyle="arc,angleA=0,armA=40,angleB=-90,armB=30,rad=7"
    ),
)
ax.annotate(
    "angle,\nangle 90",
...
ax.annotate(
    ...
    textcoords="data",
    arrowprops=dict(
        arrowstyle="<->", connectionstyle="bar", ec="k", shrinkA=5, shrinkB=5
    ),
)
...
ax.annotate(
    ...
    bbox=dict(boxstyle="round", fc="0.8"),
    arrowprops=dict(
        arrowstyle="->", patchB=el, connectionstyle="angle,angleA=90,angleB=0,rad=10"
    ),
)
ax.annotate(
    "arrow\nfancy",
...
ax.annotate(
    ...
    textcoords="offset points",
    size=20,
    bbox=dict(boxstyle="round", fc=(1.0, 0.7, 0.7), ec=(1.0, 0.5, 0.5)),
    arrowprops=dict(
