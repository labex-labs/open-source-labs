# Построить график PSD с разным количеством дополнения нулями

Далее построим график PSD с разным количеством дополнения нулями. Это делает сразу весь временной ряд.
