...
In diesem Lab lernst du, wie du mithilfe von Zylinderm koordinaten in Matplotlib einen 3D-Voxelplot erstellen kannst. Der Plot zeigt, wie die _x_, _y_ und _z_ Parameter von `.Axes3D.voxels` verwendet werden, um einen 3D-Voxelplot zu erstellen.
