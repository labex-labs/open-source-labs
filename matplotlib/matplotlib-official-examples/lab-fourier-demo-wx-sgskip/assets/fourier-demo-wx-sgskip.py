...
class FourierDemoFrame(wx.Frame):
    ...
    def createSliders(self, panel):
        self.frequencySliderGroup = SliderGroup(
            panel, label="Frequency f0:", param=self.f0
        )
        self.amplitudeSliderGroup = SliderGroup(
            panel, label=" Amplitude a:", param=self.A
        )
    ...
    def createPlots(self):
        ...
        self.subplot1.set_title(
            "Click and drag waveforms to change frequency and amplitude", fontsize=12
        )
...
class App(wx.App):
    def OnInit(self):
        self.frame1 = FourierDemoFrame(
            parent=None, title="Fourier Demo", size=(640, 480)
        )
        self.frame1.Show()
        return True
