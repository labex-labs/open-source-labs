...
class MenuItem(artist.Artist):
    ...
    def __init__(self, fig, labelstr, props=None, hoverprops=None, on_select=None):
        ...
        self.hoverprops = hoverprops if hoverprops is not None else ItemProperties()
        ...
        self.label = fig.text(
            0, 0, labelstr, transform=IdentityTransform(), size=props.fontsize
        )
        self.text_bbox = self.label.get_window_extent(fig.canvas.get_renderer())
