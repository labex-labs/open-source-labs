# Создаем пользовательские violin-графики

Мы создадим пользовательские violin-графики, изменив различные параметры. Мы создадим 5 пользовательских violin-графиков с использованием разных параметров.
