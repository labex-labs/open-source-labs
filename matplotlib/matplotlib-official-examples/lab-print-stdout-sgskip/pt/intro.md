...
Matplotlib é uma biblioteca Python utilizada para plotar gráficos e visualizações de dados. Neste laboratório, você aprenderá como usar Matplotlib para criar e salvar um gráfico de linha simples.
