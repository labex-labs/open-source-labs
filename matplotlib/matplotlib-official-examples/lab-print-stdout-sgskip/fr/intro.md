...
Matplotlib est une bibliothèque Python utilisée pour tracer des graphiques et des visualisations de données. Dans ce laboratoire, vous allez apprendre à utiliser Matplotlib pour créer et enregistrer un simple graphique en ligne.
