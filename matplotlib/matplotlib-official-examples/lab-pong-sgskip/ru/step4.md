# Определение класса "Игра"

Теперь, когда мы определили классы `Pad` и `Puck`, мы можем перейти к определению класса `Game`. Этот класс будет отвечать за обработку игровой логики и отображение игры на экране.
