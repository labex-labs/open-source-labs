# Definir a Classe Game

Agora que temos as classes `Pad` e `Puck` definidas, podemos passar para a definição da classe `Game`. Esta classe será responsável por lidar com a lógica do jogo e desenhar o jogo na tela.

```python
class Game:
    def __init__(self, ax):
        # criar a linha inicial
        self.ax = ax
