...
Neste laboratório, aprenderemos como desenhar várias formas usando a biblioteca Matplotlib em Python. Matplotlib é uma biblioteca de plotagem para a linguagem de programação Python e sua extensão de matemática numérica NumPy. Ela fornece uma API orientada a objetos para incorporar gráficos em aplicações usando toolkits GUI de uso geral como Tkinter, wxPython, Qt ou GTK.
