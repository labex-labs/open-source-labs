...
Matplotlib 는 Python 에서 널리 사용되는 데이터 시각화 라이브러리입니다. FreeType 라이브러리를 통해 폰트 지원을 제공합니다. 이 랩에서는 Matplotlib 의 `Axes.table`을 사용하여 주어진 폰트의 처음 255 개 문자에 대한 폰트 테이블을 그리는 방법을 배웁니다.
