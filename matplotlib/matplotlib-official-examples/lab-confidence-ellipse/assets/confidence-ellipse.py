...
confidence_ellipse(
    x, y, ax_nstd, n_std=2, label=r"$2\sigma$", edgecolor="fuchsia", linestyle="--"
)
confidence_ellipse(
    x, y, ax_nstd, n_std=3, label=r"$3\sigma$", edgecolor="blue", linestyle=":"
)
...
confidence_ellipse(
    x, y, ax_kwargs, alpha=0.5, facecolor="pink", edgecolor="purple", zorder=0
)
