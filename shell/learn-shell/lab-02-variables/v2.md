...
- name: Verify variables.sh file exists
  ...
  hint: |
    The variables.sh file does not exist in the /home/labex/project directory. Please create it and add the required content.
...
- name: Verify variables.sh content
  ...
  hint: |
    The variables.sh file does not contain the expected variable definitions. Please check your code and ensure all three variables are defined correctly.
```
...
- name: Verify updated variables.sh content
  ...
  hint: |
    The variables.sh file does not contain the expected echo statements. Please check your code and ensure all three echo statements are present and correct.
```
...
- name: Verify command substitution in variables.sh
  ...
  hint: |
    The variables.sh file does not contain the expected command substitution examples. Please check your code and ensure all three command substitution examples are present and correct.
```
...
- name: Verify arithmetic.sh file exists
  ...
  hint: |
    The arithmetic.sh file does not exist in the /home/labex/project directory. Please create it and add the required content.
...
- name: Verify arithmetic operations in arithmetic.sh
  ...
  hint: |
    The arithmetic.sh file does not contain all the expected arithmetic operations. Please check your code and ensure all seven arithmetic operations are present and correct.
```
...
- name: Verify environment.sh file exists
  ...
  hint: |
    The environment.sh file does not exist in the /home/labex/project directory. Please create it and add the required content.
...
- name: Verify environment variable operations in environment.sh
  ...
  hint: |
    The environment.sh file does not contain all the expected environment variable operations. Please check your code and ensure all the required operations are present and correct.
```
