...
![Choice admin page](./assets/admin09.png)
...
![Add question page now has choices on it](./assets/admin10t.png)
...
![Add question page now has more compact choices](./assets/admin11t.png)
