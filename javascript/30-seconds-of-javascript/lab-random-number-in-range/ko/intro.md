...
이 랩에서는 JavaScript 에서 난수 생성기를 만드는 개념을 탐구합니다. `Math.random()` 메서드를 사용하여 임의의 값을 생성하고 곱셈을 사용하여 원하는 범위에 매핑합니다. 이 랩을 마치면 JavaScript 에서 난수를 생성하고 프로젝트에서 사용하는 방법에 대한 이해도가 높아질 것입니다.
