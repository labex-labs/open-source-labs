# Das geschachtelte Wert abgerufen

## Problem

Schreiben Sie eine Funktion `get(d, selectors)`, die ein Wörterbuch oder eine Liste `d` und eine Liste von Selektoren `selectors` als Argumente nimmt und den Wert des geschachtelten Schlüssels zurückgibt, der durch die gegebene Selektorenliste angegeben wird. Wenn der Schlüssel nicht existiert, geben Sie `None` zurück.
