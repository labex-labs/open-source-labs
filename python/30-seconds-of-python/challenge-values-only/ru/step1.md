...
Для решения этой задачи вы можете использовать метод `dict.values()` для возврата значений в заданном словаре. Затем вы можете преобразовать результат в список с использованием функции `list()`.
