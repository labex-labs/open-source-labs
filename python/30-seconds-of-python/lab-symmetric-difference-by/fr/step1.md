...
2. Utilisez une compréhension de liste en combinaison avec `fn` pour chacun d'entre eux pour ne conserver que les valeurs qui ne sont pas contenues dans l'ensemble précédemment créé de l'autre.
