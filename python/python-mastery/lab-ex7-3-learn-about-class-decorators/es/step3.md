...
4. Ahora, actualicemos nuestro archivo `stock.py` para aprovechar esta nueva característica. Abra el archivo `stock.py` en su editor para modificarlo. Este archivo contiene la definición de la clase `Stock`, y vamos a hacer que herede de la clase `Structure` para usar la aplicación automática del decorador.

5. Modifique el archivo `stock.py` para eliminar el decorador explícito:
...
6. Vuelva a ejecutar las pruebas para verificar que todo sigue funcionando:
