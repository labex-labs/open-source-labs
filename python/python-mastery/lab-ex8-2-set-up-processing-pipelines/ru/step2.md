# Создание дополнительных компонентов конвейера

В файле `ticker.py` определите следующий класс (используя свой код структуры из предыдущего примера) и настройте конвейер:
...
При запуске этого кода вы должны увидеть такой вывод:
