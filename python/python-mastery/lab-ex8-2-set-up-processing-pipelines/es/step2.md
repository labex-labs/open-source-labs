# Creando más componentes de la tubería

En un archivo `ticker.py`, define la siguiente clase (utilizando tu código de estructura anterior) y configura una tubería:
...
Cuando ejecutes esto, deberías ver una salida como esta:
