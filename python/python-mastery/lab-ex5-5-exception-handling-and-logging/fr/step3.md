...
Modifiez le code de manière à émettre des messages d'avertissement à l'aide du module `logging`. En outre, donnez des informations de débogage optionnelles indiquant la raison de l'échec. Par exemple :
