...
Dans le fichier `reader.py`, il y a une fonction centrale `convert_csv()` qui effectue la majeure partie du travail. Cette fonction plante si vous l'exécutez sur des données avec des données manquantes ou erronées. Par exemple :
