...
Modifique el código para que los mensajes de advertencia se emitan utilizando el módulo `logging`. Además, proporcione información de depuración opcional que indique la razón del error. Por ejemplo:
