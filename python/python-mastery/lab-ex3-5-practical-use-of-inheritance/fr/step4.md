# Ajout de plus nombreuses implémentations

Créez une classe `CSVTableFormatter` qui permet de générer une sortie au format CSV :
...
Créez une classe `HTMLTableFormatter` qui génère une sortie au format HTML :
