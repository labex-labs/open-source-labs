# Agregando más implementaciones

Crea una clase `CSVTableFormatter` que permita generar la salida en formato CSV:
...
Crea una clase `HTMLTableFormatter` que genere la salida en formato HTML:
