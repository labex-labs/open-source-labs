# Hinzufügen weiterer Implementierungen

Erstellen Sie eine Klasse `CSVTableFormatter`, die es ermöglicht, Ausgabe im CSV-Format zu generieren:
...
Erstellen Sie eine Klasse `HTMLTableFormatter`, die Ausgabe im HTML-Format generiert:
