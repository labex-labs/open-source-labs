# Ejercicio 6.9: Configurar una tubería más compleja
...
Bueno, eso es interesante. Lo que estás viendo aquí es que la salida de la función `follow()` se ha conectado a la función `csv.reader()` y ahora estamos obteniendo una secuencia de filas divididas.
