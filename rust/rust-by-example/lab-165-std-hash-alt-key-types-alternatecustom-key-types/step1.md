...
Note that `f32` and `f64` do _not_ implement `Hash`, likely because floating-point precision errors would make using them as hashmap keys horribly error-prone.
