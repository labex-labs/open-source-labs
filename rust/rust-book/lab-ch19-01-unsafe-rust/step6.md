...
and use of a _Foreign Function Interface_ _(FFI)_, which is a way for a
...
_application binary interface_ _(ABI)_ the external function uses: the ABI
...
> the Rust compiler not to mangle the name of this function. _Mangling_ is when a
