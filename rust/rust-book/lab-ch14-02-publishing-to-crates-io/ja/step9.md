...
注意してください。公開は _恒久的_ です。バージョンは決して上書きできず、コードを削除することもできません。Crates.io の主な目的の 1 つは、コードの恒久的なアーカイブとして機能することです。そうすることで、*https://crates.io* のクレートに依存するすべてのプロジェクトのビルドが継続して機能するようになります。バージョンの削除を許可すると、その目的を達成することが不可能になります。ただし、公開できるクレートのバージョン数に制限はありません。
