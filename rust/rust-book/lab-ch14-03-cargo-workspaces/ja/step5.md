...
出力の最初のセクションは、`add_one`クレート内の`it_works`テストが合格したことを示しています。次のセクションは、`adder`クレートで 0 個のテストが見つかったことを示しており、最後のセクションは、`add_one`クレートで 0 個のドキュメントテストが見つかったことを示しています。
