...
これまでに定義した構造体はすべて、所有型を保持していました。構造体を参照を保持するように定義することもできますが、その場合、構造体定義内の各参照に寿命注釈を付ける必要があります。リスト10-24には、文字列スライスを保持する`ImportantExcerpt`という名前の構造体があります。
