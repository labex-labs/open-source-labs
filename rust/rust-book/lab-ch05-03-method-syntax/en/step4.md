...
The `Self` keywords in the return type \[1\] and in the body of the function \[2\] are aliases for the type that appears after the `impl` keyword, which in this case is `Rectangle`.
