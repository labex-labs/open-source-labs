...
1対残り（One-vs-the-Rest、OvR）の多クラス戦略は、`n_classes`それぞれについてROC曲線を計算することから成ります。各ステップで、特定のクラスを陽性クラスとみなし、残りのクラスを一括して陰性クラスとみなします。このステップでは、OvR多クラス戦略を使用してROC曲線をどのように計算するかを示します。
