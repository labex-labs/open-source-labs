# Erstellen Sie die Anzeigeklasse

Die Anzeigeklasse wird verwendet, um die grafische Benutzeroberfläche (GUI) anzuzeigen und die Interaktionen des Benutzers zu verarbeiten.
