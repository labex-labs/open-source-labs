...
> You can open the `31-partial-dependence-and-individual-conditional-expectation-plots.ipynb` in WebIDE to start the exercises. Learn how to use [Jupyter Notebooks in VS Code](https://code.visualstudio.com/docs/datascience/jupyter-notebooks).
