...
This is a Guided Lab, which provides step-by-step instructions to help you learn and practice. Follow the instructions carefully to complete each step and gain hands-on experience. Historical data shows that this is a <span class="text-green-600 dark:text-green-400">beginner</span> level lab with a <span class="text-green-600 dark:text-green-400">88%</span> completion rate. It has received a <span class="text-primary-600 dark:text-primary-400">67%</span> positive review rate from learners.
</div>
